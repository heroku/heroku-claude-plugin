export const meta = {
  ...
  whenToUse: "Run from a session launched with: HEROKU_TOKEN_BUDGET_TRACKING=1 claude --plugin-dir /path/to/heroku-plugin --dangerously-skip-permissions. Each scenario deploys a real Heroku app and runs teardown. Requires an authenticated Heroku account and moot-server running.",
  phases: [
